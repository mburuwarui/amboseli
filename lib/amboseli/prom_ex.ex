defmodule Amboseli.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     defmodule AmboseliWeb.Endpoint do
       ...
       plug PromEx.Plug, prom_ex_module: Amboseli.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: AmboseliWeb.Router, endpoint: AmboseliWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:amboseli, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
