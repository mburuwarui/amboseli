defmodule AmboseliWeb.CoreComponents do
          ...
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            ...
            >
              <div class="absolute top-6 right-5">
                ...
                >
                  <.icon name="hero-x-mark-solid" class="h-5 w-5 dark:bg-zinc-100" />
                </button>
              </div>
              <div id={"#{@id}-content"}>
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-16 right-2 mr-2 w-80 sm:w-96 z-50 rounded-lg p-3 ring-1",
        @kind == :info &&
          "bg-emerald-50 dark:bg-emerald-900 text-emerald-800 dark:text-emerald-300 ring-emerald-500 dark:ring-emerald-400 fill-cyan-900 dar:fill-cyan-50",
        @kind == :error &&
          "bg-rose-50 dark:bg-rose-900 text-rose-900 dark:text-rose-200 shadow-md ring-rose-500 dark:ring-rose-400 fill-rose-900 dark:fill-rose-50"
      ]}
      {@rest}
    >
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-zinc-900 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700 hover:bg-zinc-700 py-2 px-3",
        "text-sm font-semibold leading-6 text-white dark:text-zinc-100 active:text-white/80 dark:active:text-zinc-200",
        @class
      ]}
      {@rest}
    >
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        id={@id}
        name={@name}
        class="form-multiselect mt-2 block w-full rounded-md border border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 shadow-sm focus:border-zinc-400 dark:focus:border-zinc-600 focus:ring-0 sm:text-sm dark:text-white"
        multiple={@multiple}
        {@rest}
      >
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        class={[
          ...
          "min-h-[6rem] phx-no-feedback:border-zinc-300 dark:phx-no-feedback:border-zinc-700 phx-no-feedback:focus:border-zinc-400 dark:phx-no-feedback:focus:border-zinc-600",
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        ...
        <tbody
          ...
          class="relative divide-y divide-zinc-100 dark:divide-zinc-700 border-t border-zinc-200 dark:border-zinc-500 text-sm leading-6 text-zinc-700 dark:text-zinc-200"
        >
          <tr
            :for={row <- @rows}
          ...
          >
            ...
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium">
                ...
                <span
                  :for={action <- @action}
                  class="relative ml-4 font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-zinc-700 dark:hover:text-zinc-100"
                >
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-zinc-700 dark:hover:text-zinc-50"
      >
